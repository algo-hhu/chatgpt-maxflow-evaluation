...
int hi_pr::parse(
				 ...
				 cType   **cap_ad,              /* address of the array of capacities */
				 node    **source_ad,           /* address of the pointer to the source */
				 node    **sink_ad,             /* address of the pointer to the sink */
...
#define EN22 20
	...
	{ 
		...
		/* 8*/    "this parser doesn't support multiple sources and sinks.",
	...
	*/
	...
	//AS: this is a fix for nodes, not having outgoing arcs
